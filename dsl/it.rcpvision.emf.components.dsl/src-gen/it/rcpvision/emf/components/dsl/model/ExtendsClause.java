 ...
 * <ul>
 *   <li>{@link it.rcpvision.emf.components.dsl.model.ExtendsClause#getSuperType <em>Super Type</em>}</li>
 * </ul>
 * </p>
 *
 * @see it.rcpvision.emf.components.dsl.model.ModelPackage#getExtendsClause()
 * @model
 * @generated
 */
public interface ExtendsClause extends EObject
{
   ...
   * @see it.rcpvision.emf.components.dsl.model.ModelPackage#getExtendsClause_SuperType()
  ...
  /**
   * Sets the value of the '{@link it.rcpvision.emf.components.dsl.model.ExtendsClause#getSuperType <em>Super Type</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
