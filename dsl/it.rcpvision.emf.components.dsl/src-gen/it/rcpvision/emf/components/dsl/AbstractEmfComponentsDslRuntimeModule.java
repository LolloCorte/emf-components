...
/**
 * Manual modifications go to {it.rcpvision.emf.components.dsl.EmfComponentsDslRuntimeModule}
 */
 @SuppressWarnings("all")
public abstract class AbstractEmfComponentsDslRuntimeModule extends DefaultRuntimeModule {

	protected Properties properties = null;

	@Override
	public void configure(Binder binder) {
		properties = tryBindProperties(binder, "it/rcpvision/emf/components/dsl/EmfComponentsDsl.properties");
		super.configure(binder);
	}
	
	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance("it.rcpvision.emf.components.dsl.EmfComponentsDsl");
	}
	
	public void configureFileExtensions(Binder binder) {
		if (properties == null || properties.getProperty(Constants.FILE_EXTENSIONS) == null)
			binder.bind(String.class).annotatedWith(Names.named(Constants.FILE_EXTENSIONS)).toInstance("emfcomponents");
	}
	
	// contributed by org.eclipse.xtext.generator.grammarAccess.GrammarAccessFragment
	public Class<? extends org.eclipse.xtext.IGrammarAccess> bindIGrammarAccess() {
		return it.rcpvision.emf.components.dsl.services.EmfComponentsDslGrammarAccess.class;
	}

	// contributed by org.eclipse.xtext.generator.serializer.SerializerFragment
	public Class<? extends org.eclipse.xtext.serializer.sequencer.ISemanticSequencer> bindISemanticSequencer() {
		return it.rcpvision.emf.components.dsl.serializer.EmfComponentsDslSemanticSequencer.class;
	}

	// contributed by org.eclipse.xtext.generator.serializer.SerializerFragment
	public Class<? extends org.eclipse.xtext.serializer.sequencer.ISyntacticSequencer> bindISyntacticSequencer() {
		return it.rcpvision.emf.components.dsl.serializer.EmfComponentsDslSyntacticSequencer.class;
	}
	...
	public Class<? extends org.eclipse.xtext.parser.IParser> bindIParser() {
		return it.rcpvision.emf.components.dsl.parser.antlr.EmfComponentsDslParser.class;
	}
	...
	public Class<? extends org.eclipse.xtext.parser.antlr.IAntlrTokenFileProvider> bindIAntlrTokenFileProvider() {
		return it.rcpvision.emf.components.dsl.parser.antlr.EmfComponentsDslAntlrTokenFileProvider.class;
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment
	public Class<? extends org.eclipse.xtext.parser.antlr.Lexer> bindLexer() {
		return it.rcpvision.emf.components.dsl.parser.antlr.internal.InternalEmfComponentsDslLexer.class;
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment
	public com.google.inject.Provider<it.rcpvision.emf.components.dsl.parser.antlr.internal.InternalEmfComponentsDslLexer> provideInternalEmfComponentsDslLexer() {
		return org.eclipse.xtext.parser.antlr.LexerProvider.create(it.rcpvision.emf.components.dsl.parser.antlr.internal.InternalEmfComponentsDslLexer.class);
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment
	public void configureRuntimeLexer(com.google.inject.Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class).annotatedWith(com.google.inject.name.Names.named(org.eclipse.xtext.parser.antlr.LexerBindings.RUNTIME)).to(it.rcpvision.emf.components.dsl.parser.antlr.internal.InternalEmfComponentsDslLexer.class);
	}
	...
	@org.eclipse.xtext.service.SingletonBinding(eager=true)	public Class<? extends it.rcpvision.emf.components.dsl.validation.EmfComponentsDslJavaValidator> bindEmfComponentsDslJavaValidator() {
		return it.rcpvision.emf.components.dsl.validation.EmfComponentsDslJavaValidator.class;
	}
	...
	public Class<? extends org.eclipse.xtext.formatting.IFormatter> bindIFormatter() {
		return it.rcpvision.emf.components.dsl.formatting.EmfComponentsDslFormatter.class;
	}
	...
	public Class<? extends org.eclipse.xtext.xbase.jvmmodel.IJvmModelInferrer> bindIJvmModelInferrer() {
		return it.rcpvision.emf.components.dsl.jvmmodel.EmfComponentsDslJvmModelInferrer.class;
	}
