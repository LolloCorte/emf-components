...
(
		{ 
	        newCompositeNode(grammarAccess.getModuleAccess().getLabelProviderLabelProviderParserRuleCall_3_0_0()); 
	    }
		lv_labelProvider_4_0=ruleLabelProvider		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getModuleRule());
	        }
       		set(
...
(
		{ 
	        newCompositeNode(grammarAccess.getModuleAccess().getFormControlFactoryFormControlFactoryParserRuleCall_3_3_0()); 
	    }
		lv_formControlFactory_7_0=ruleFormControlFactory		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getModuleRule());
	        }
       		set(
...
(
		{ 
	        newCompositeNode(grammarAccess.getModuleAccess().getViewerContentProviderViewerContentProviderParserRuleCall_3_4_0()); 
	    }
		lv_viewerContentProvider_8_0=ruleViewerContentProvider		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getModuleRule());
	        }
       		set(
...
(
		{ 
	        newCompositeNode(grammarAccess.getFeatureSpecificationAccess().getFeaturesXFeatureCallParserRuleCall_2_0()); 
	    }
		lv_features_2_0=ruleXFeatureCall		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getFeatureSpecificationRule());
	        }
       		add(
...
(
		{ 
	        newCompositeNode(grammarAccess.getFeatureSpecificationAccess().getFeaturesXFeatureCallParserRuleCall_3_1_0()); 
	    }
		lv_features_4_0=ruleXFeatureCall		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getFeatureSpecificationRule());
	        }
       		add(
...
(
		{ 
	        newCompositeNode(grammarAccess.getFormControlSpecificationAccess().getFeatureXFeatureCallParserRuleCall_2_0()); 
	    }
		lv_feature_2_0=ruleXFeatureCall		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getFormControlSpecificationRule());
