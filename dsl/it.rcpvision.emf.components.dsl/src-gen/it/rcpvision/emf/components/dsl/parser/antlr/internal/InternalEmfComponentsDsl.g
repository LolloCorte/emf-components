...
(
		{ 
	        newCompositeNode(grammarAccess.getModuleAccess().getLabelProviderLabelProviderParserRuleCall_3_0()); 
	    }
		lv_labelProvider_3_0=ruleLabelProvider		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getModuleRule());
	        }
       		set(
