...
public class EmfComponentsDslSyntacticSequencer extends AbstractSyntacticSequencer {
	...
	protected AbstractElementAlias match_ViewSpecification___LeftCurlyBracketKeyword_2_0_RightCurlyBracketKeyword_2_1__q;
	...
	protected void init(IGrammarAccess access) {
		...
		match_ViewSpecification___LeftCurlyBracketKeyword_2_0_RightCurlyBracketKeyword_2_1__q = new GroupAlias(false, true, new TokenAlias(false, false, grammarAccess.getViewSpecificationAccess().getLeftCurlyBracketKeyword_2_0()), new TokenAlias(false, false, grammarAccess.getViewSpecificationAccess().getRightCurlyBracketKeyword_2_1()));
	...
	protected void emitUnassignedTokens(EObject semanticObject, ISynTransition transition, INode fromNode, INode toNode) {
		...
		for (AbstractElementAlias syntax : transition.getAmbiguousSyntaxes()) {
			...
			else if(match_ViewSpecification___LeftCurlyBracketKeyword_2_0_RightCurlyBracketKeyword_2_1__q.equals(syntax))
				emit_ViewSpecification___LeftCurlyBracketKeyword_2_0_RightCurlyBracketKeyword_2_1__q(semanticObject, getLastNavigableState(), syntaxNodes);
	 ...
	 *     ('{' '}')?
	 */
	protected void emit_ViewSpecification___LeftCurlyBracketKeyword_2_0_RightCurlyBracketKeyword_2_1__q(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
		acceptNodes(transition, nodes);
	}
