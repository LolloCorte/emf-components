...
public class EmfComponentsDslSyntacticSequencer extends AbstractSyntacticSequencer {
	...
	protected AbstractElementAlias match_Module___PartsKeyword_4_5_0_LeftCurlyBracketKeyword_4_5_1_RightCurlyBracketKeyword_4_5_3__a;
	protected AbstractElementAlias match_Module___RightCurlyBracketKeyword_4_5_3_PartsKeyword_4_5_0_LeftCurlyBracketKeyword_4_5_1__a;
	...
	protected void init(IGrammarAccess access) {
		...
		match_Module___PartsKeyword_4_5_0_LeftCurlyBracketKeyword_4_5_1_RightCurlyBracketKeyword_4_5_3__a = new GroupAlias(true, true, new TokenAlias(false, false, grammarAccess.getModuleAccess().getPartsKeyword_4_5_0()), new TokenAlias(false, false, grammarAccess.getModuleAccess().getLeftCurlyBracketKeyword_4_5_1()), new TokenAlias(false, false, grammarAccess.getModuleAccess().getRightCurlyBracketKeyword_4_5_3()));
		match_Module___RightCurlyBracketKeyword_4_5_3_PartsKeyword_4_5_0_LeftCurlyBracketKeyword_4_5_1__a = new GroupAlias(true, true, new TokenAlias(false, false, grammarAccess.getModuleAccess().getRightCurlyBracketKeyword_4_5_3()), new TokenAlias(false, false, grammarAccess.getModuleAccess().getPartsKeyword_4_5_0()), new TokenAlias(false, false, grammarAccess.getModuleAccess().getLeftCurlyBracketKeyword_4_5_1()));
	...
	protected void emitUnassignedTokens(EObject semanticObject, ISynTransition transition, INode fromNode, INode toNode) {
		...
		for (AbstractElementAlias syntax : transition.getAmbiguousSyntaxes()) {
			...
			else if(match_Module___PartsKeyword_4_5_0_LeftCurlyBracketKeyword_4_5_1_RightCurlyBracketKeyword_4_5_3__a.equals(syntax))
				emit_Module___PartsKeyword_4_5_0_LeftCurlyBracketKeyword_4_5_1_RightCurlyBracketKeyword_4_5_3__a(semanticObject, getLastNavigableState(), syntaxNodes);
			else if(match_Module___RightCurlyBracketKeyword_4_5_3_PartsKeyword_4_5_0_LeftCurlyBracketKeyword_4_5_1__a.equals(syntax))
				emit_Module___RightCurlyBracketKeyword_4_5_3_PartsKeyword_4_5_0_LeftCurlyBracketKeyword_4_5_1__a(semanticObject, getLastNavigableState(), syntaxNodes);
	 ...
	 *     ('parts' '{' '}')*
	 */
	protected void emit_Module___PartsKeyword_4_5_0_LeftCurlyBracketKeyword_4_5_1_RightCurlyBracketKeyword_4_5_3__a(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
		acceptNodes(transition, nodes);
	}
	 ...
	 *     ('}' 'parts' '{')*
	 */
	protected void emit_Module___RightCurlyBracketKeyword_4_5_3_PartsKeyword_4_5_0_LeftCurlyBracketKeyword_4_5_1__a(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
		acceptNodes(transition, nodes);
	}
