...
public class EmfComponentsDslSyntacticSequencer extends AbstractSyntacticSequencer {
	...
	protected AbstractElementAlias match_FormFeatureControlFactory___ControlKeyword_3_0_LeftCurlyBracketKeyword_3_1_RightCurlyBracketKeyword_3_3__q;
	...
	protected AbstractElementAlias match_Module___PartsKeyword_3_5_0_LeftCurlyBracketKeyword_3_5_1_RightCurlyBracketKeyword_3_5_3__a;
	protected AbstractElementAlias match_Module___RightCurlyBracketKeyword_3_5_3_PartsKeyword_3_5_0_LeftCurlyBracketKeyword_3_5_1__a;
	...
	protected void init(IGrammarAccess access) {
		...
		match_FormFeatureControlFactory___ControlKeyword_3_0_LeftCurlyBracketKeyword_3_1_RightCurlyBracketKeyword_3_3__q = new GroupAlias(false, true, new TokenAlias(false, false, grammarAccess.getFormFeatureControlFactoryAccess().getControlKeyword_3_0()), new TokenAlias(false, false, grammarAccess.getFormFeatureControlFactoryAccess().getLeftCurlyBracketKeyword_3_1()), new TokenAlias(false, false, grammarAccess.getFormFeatureControlFactoryAccess().getRightCurlyBracketKeyword_3_3()));
		...
		match_Module___PartsKeyword_3_5_0_LeftCurlyBracketKeyword_3_5_1_RightCurlyBracketKeyword_3_5_3__a = new GroupAlias(true, true, new TokenAlias(false, false, grammarAccess.getModuleAccess().getPartsKeyword_3_5_0()), new TokenAlias(false, false, grammarAccess.getModuleAccess().getLeftCurlyBracketKeyword_3_5_1()), new TokenAlias(false, false, grammarAccess.getModuleAccess().getRightCurlyBracketKeyword_3_5_3()));
		match_Module___RightCurlyBracketKeyword_3_5_3_PartsKeyword_3_5_0_LeftCurlyBracketKeyword_3_5_1__a = new GroupAlias(true, true, new TokenAlias(false, false, grammarAccess.getModuleAccess().getRightCurlyBracketKeyword_3_5_3()), new TokenAlias(false, false, grammarAccess.getModuleAccess().getPartsKeyword_3_5_0()), new TokenAlias(false, false, grammarAccess.getModuleAccess().getLeftCurlyBracketKeyword_3_5_1()));
	...
	protected void emitUnassignedTokens(EObject semanticObject, ISynTransition transition, INode fromNode, INode toNode) {
		...
		for (AbstractElementAlias syntax : transition.getAmbiguousSyntaxes()) {
			...
			else if(match_FormFeatureControlFactory___ControlKeyword_3_0_LeftCurlyBracketKeyword_3_1_RightCurlyBracketKeyword_3_3__q.equals(syntax))
				emit_FormFeatureControlFactory___ControlKeyword_3_0_LeftCurlyBracketKeyword_3_1_RightCurlyBracketKeyword_3_3__q(semanticObject, getLastNavigableState(), syntaxNodes);
			...
			else if(match_Module___PartsKeyword_3_5_0_LeftCurlyBracketKeyword_3_5_1_RightCurlyBracketKeyword_3_5_3__a.equals(syntax))
				emit_Module___PartsKeyword_3_5_0_LeftCurlyBracketKeyword_3_5_1_RightCurlyBracketKeyword_3_5_3__a(semanticObject, getLastNavigableState(), syntaxNodes);
			else if(match_Module___RightCurlyBracketKeyword_3_5_3_PartsKeyword_3_5_0_LeftCurlyBracketKeyword_3_5_1__a.equals(syntax))
				emit_Module___RightCurlyBracketKeyword_3_5_3_PartsKeyword_3_5_0_LeftCurlyBracketKeyword_3_5_1__a(semanticObject, getLastNavigableState(), syntaxNodes);
	 ...
	 *     ('control' '{' '}')?
	 */
	protected void emit_FormFeatureControlFactory___ControlKeyword_3_0_LeftCurlyBracketKeyword_3_1_RightCurlyBracketKeyword_3_3__q(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
		acceptNodes(transition, nodes);
	}
	 ...
	 *     ('parts' '{' '}')*
	 */
	protected void emit_Module___PartsKeyword_3_5_0_LeftCurlyBracketKeyword_3_5_1_RightCurlyBracketKeyword_3_5_3__a(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
		acceptNodes(transition, nodes);
	}
	 ...
	 *     ('}' 'parts' '{')*
	 */
	protected void emit_Module___RightCurlyBracketKeyword_3_5_3_PartsKeyword_3_5_0_LeftCurlyBracketKeyword_3_5_1__a(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
		acceptNodes(transition, nodes);
	}
