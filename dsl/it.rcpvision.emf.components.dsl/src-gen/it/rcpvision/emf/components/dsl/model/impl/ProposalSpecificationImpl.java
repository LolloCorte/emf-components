 ...
 * <ul>
 *   <li>{@link it.rcpvision.emf.components.dsl.model.impl.ProposalSpecificationImpl#getFeature <em>Feature</em>}</li>
 *   <li>{@link it.rcpvision.emf.components.dsl.model.impl.ProposalSpecificationImpl#getExpression <em>Expression</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ProposalSpecificationImpl extends EmfFeatureAccessImpl implements ProposalSpecification
{
  ...
  public NotificationChain basicSetFeature(XExpression newFeature, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ModelPackage.PROPOSAL_SPECIFICATION__FEATURE, oldFeature, newFeature);
  ...
  public void setFeature(XExpression newFeature)
  {
    if (newFeature != feature)
    {
      ...
      if (feature != null)
        msgs = ((InternalEObject)feature).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ModelPackage.PROPOSAL_SPECIFICATION__FEATURE, null, msgs);
      if (newFeature != null)
        msgs = ((InternalEObject)newFeature).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ModelPackage.PROPOSAL_SPECIFICATION__FEATURE, null, msgs);
      msgs = basicSetFeature(newFeature, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.PROPOSAL_SPECIFICATION__FEATURE, newFeature, newFeature));
  }
