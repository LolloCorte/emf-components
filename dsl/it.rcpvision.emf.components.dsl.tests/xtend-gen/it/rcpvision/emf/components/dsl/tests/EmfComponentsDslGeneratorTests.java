...
public class EmfComponentsDslGeneratorTests extends EmfComponentsDslAbstractTests {
  ...
  public void testProposalSpecifications() {
    ...
    _builder_1.append("import it.rcpvision.emf.components.examples.library.Book;");
    _builder_1.newLine();
    _builder_1.append("import it.rcpvision.emf.components.examples.library.Borrower;");
    _builder_1.newLine();
    ...
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("List<Object> _doubleArrow = ObjectExtensions.<List<Object>>operator_doubleArrow(_defaultProposals, _function);");
    _builder_1.newLine();
    _builder_1.append("    ");
