...
:
(
{ before(grammarAccess.getViewSpecificationAccess().getRightCurlyBracketKeyword_8()); }

	'}' 

{ after(grammarAccess.getViewSpecificationAccess().getRightCurlyBracketKeyword_8()); }
)
