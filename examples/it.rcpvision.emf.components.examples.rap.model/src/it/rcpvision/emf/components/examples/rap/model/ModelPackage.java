 ...
 * </ul>
 * <!-- end-user-doc -->
 * @see it.rcpvision.emf.components.examples.rap.model.ModelFactory
 * @model kind="package"
 * @generated
 */
public interface ModelPackage extends EPackage {
	 ...
	 * @generated
	 */
	ModelPackage eINSTANCE = it.rcpvision.emf.components.examples.rap.model.impl.ModelPackageImpl.init();

	/**
	 * The meta object id for the '{@link it.rcpvision.emf.components.examples.rap.model.impl.ModelImpl <em>Model</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see it.rcpvision.emf.components.examples.rap.model.impl.ModelImpl
	 * @see it.rcpvision.emf.components.examples.rap.model.impl.ModelPackageImpl#getModel()
	 * @generated
	 */
	int MODEL = 0;
	...
	/**
	 * Returns the meta object for class '{@link it.rcpvision.emf.components.examples.rap.model.Model <em>Model</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Model</em>'.
	 * @see it.rcpvision.emf.components.examples.rap.model.Model
	 * @generated
	 */
	EClass getModel();

	/**
	 * Returns the meta object for the attribute '{@link it.rcpvision.emf.components.examples.rap.model.Model#getName <em>Name</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Name</em>'.
	 * @see it.rcpvision.emf.components.examples.rap.model.Model#getName()
	 * @see #getModel()
	 * @generated
	 */
	...
	interface Literals {
		/**
		 * The meta object literal for the '{@link it.rcpvision.emf.components.examples.rap.model.impl.ModelImpl <em>Model</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see it.rcpvision.emf.components.examples.rap.model.impl.ModelImpl
		 * @see it.rcpvision.emf.components.examples.rap.model.impl.ModelPackageImpl#getModel()
