...
import it.rcpvision.emf.components.examples.library.presentation.EXTLibraryActionBarContributor;
...
public class EXTLibraryExtendedActionBarContributor extends EXTLibraryActionBarContributor
{
  ...
  /*
   * @see it.rcpvision.emf.components.examples.library.presentation.EXTLibraryActionBarContributor#generateCreateChildActions(java.util.Collection,
  ...
  /*
   * @see it.rcpvision.emf.components.examples.library.presentation.EXTLibraryActionBarContributor#generateCreateSiblingActions(java.util.Collection,
   *      org.eclipse.jface.viewers.ISelection)
   */
  @Override
