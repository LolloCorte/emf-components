 ...
 */
package it.rcpvision.emf.components.examples.library.impl;
...
import it.rcpvision.emf.components.examples.library.Employee;
import it.rcpvision.emf.components.examples.library.Item;
 ...
 * <ul>
 *   <li>{@link it.rcpvision.emf.components.examples.library.impl.LibraryImpl#getAddress <em>Address</em>}</li>
 *   <li>{@link it.rcpvision.emf.components.examples.library.impl.LibraryImpl#getName <em>Name</em>}</li>
 *   <li>{@link it.rcpvision.emf.components.examples.library.impl.LibraryImpl#getWriters <em>Writers</em>}</li>
 *   <li>{@link it.rcpvision.emf.components.examples.library.impl.LibraryImpl#getEmployees <em>Employees</em>}</li>
 *   <li>{@link it.rcpvision.emf.components.examples.library.impl.LibraryImpl#getBorrowers <em>Borrowers</em>}</li>
 *   <li>{@link it.rcpvision.emf.components.examples.library.impl.LibraryImpl#getStock <em>Stock</em>}</li>
 *   <li>{@link it.rcpvision.emf.components.examples.library.impl.LibraryImpl#getBooks <em>Books</em>}</li>
 *   <li>{@link it.rcpvision.emf.components.examples.library.impl.LibraryImpl#getBranches <em>Branches</em>}</li>
 *   <li>{@link it.rcpvision.emf.components.examples.library.impl.LibraryImpl#getParentBranch <em>Parent Branch</em>}</li>
 *   <li>{@link it.rcpvision.emf.components.examples.library.impl.LibraryImpl#getPeople <em>People</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
