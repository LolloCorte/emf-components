 ...
 * <ul>
 *   <li>{@link it.rcpvision.emf.components.examples.library.impl.BookImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link it.rcpvision.emf.components.examples.library.impl.BookImpl#getPages <em>Pages</em>}</li>
 *   <li>{@link it.rcpvision.emf.components.examples.library.impl.BookImpl#getCategory <em>Category</em>}</li>
 *   <li>{@link it.rcpvision.emf.components.examples.library.impl.BookImpl#getAuthor <em>Author</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
