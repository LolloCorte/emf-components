...
import it.rcpvision.emf.components.examples.library.Addressable;
import it.rcpvision.emf.components.examples.library.AudioVisualItem;
import it.rcpvision.emf.components.examples.library.Book;
import it.rcpvision.emf.components.examples.library.BookCategory;
...
import it.rcpvision.emf.components.examples.library.CirculatingItem;
...
public class EXTLibraryPackageImpl extends EPackageImpl implements EXTLibraryPackage
{
   ...
   * @see it.rcpvision.emf.components.examples.library.EXTLibraryPackage#eNS_URI
   * @see #init()
   * @generated
   */
