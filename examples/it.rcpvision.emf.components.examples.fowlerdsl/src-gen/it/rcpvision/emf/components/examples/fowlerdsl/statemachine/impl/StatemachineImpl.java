 ...
 *
 */
package it.rcpvision.emf.components.examples.fowlerdsl.statemachine.impl;

import it.rcpvision.emf.components.examples.fowlerdsl.statemachine.Command;
import it.rcpvision.emf.components.examples.fowlerdsl.statemachine.Event;
import it.rcpvision.emf.components.examples.fowlerdsl.statemachine.State;
import it.rcpvision.emf.components.examples.fowlerdsl.statemachine.Statemachine;
import it.rcpvision.emf.components.examples.fowlerdsl.statemachine.StatemachinePackage;
 ...
 * <ul>
 *   <li>{@link it.rcpvision.emf.components.examples.fowlerdsl.statemachine.impl.StatemachineImpl#getEvents <em>Events</em>}</li>
 *   <li>{@link it.rcpvision.emf.components.examples.fowlerdsl.statemachine.impl.StatemachineImpl#getResetEvents <em>Reset Events</em>}</li>
 *   <li>{@link it.rcpvision.emf.components.examples.fowlerdsl.statemachine.impl.StatemachineImpl#getCommands <em>Commands</em>}</li>
 *   <li>{@link it.rcpvision.emf.components.examples.fowlerdsl.statemachine.impl.StatemachineImpl#getStates <em>States</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
