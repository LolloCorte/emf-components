...
import it.rcpvision.emf.components.examples.fowlerdsl.statemachine.StatemachineFactory;
...
public class StatemachinePackageImpl extends EPackageImpl implements StatemachinePackage
{
   ...
   * @see it.rcpvision.emf.components.examples.fowlerdsl.statemachine.StatemachinePackage#eNS_URI
   * @see #init()
   * @generated
   */
