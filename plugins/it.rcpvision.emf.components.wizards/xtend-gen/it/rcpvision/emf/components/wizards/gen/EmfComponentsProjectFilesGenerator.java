...
public class EmfComponentsProjectFilesGenerator {
  ...
  public CharSequence generateActivator(final String projectName) {
    ...
    _builder.newLine();
    _builder.append("import static com.google.inject.Guice.createInjector;");
    _builder.newLine();
    _builder.newLine();
    _builder.append("/**");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("\t");
    _builder.append("// the singleton Injector instance for this plugin");
    _builder.newLine();
    _builder.append("\t");
    ...
    _builder.newLine();
    _builder.append("\t ");
    _builder.append("* Returns the singleton Injector for this plugin");
    _builder.newLine();
    _builder.append("\t ");
    _builder.append("*");
    _builder.newLine();
    _builder.append("\t ");
    _builder.append("* @return the singleton Injector for this plugin");
    _builder.newLine();
    _builder.append("\t ");
    _builder.append("*/");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("injector = createInjector(createModule());");
    _builder.newLine();
    _builder.append("\t\t");
