...
public class EmfComponentsProjectFilesGenerator {
  ...
  public CharSequence generateExecutableExtensionFactory(final String projectName) {
    ...
    _builder.newLine();
    _builder.append("import it.rcpvision.emf.components.service.EmfComponentsGenericModule;");
    _builder.newLine();
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("return new EmfComponentsGuiceModule(Activator.getDefault());");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("}");
    _builder.newLine();
